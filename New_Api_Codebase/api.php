...
Route::get('/refer/player',[GameManagerController::class,'SetReferCode']);
...
// New route for adding reward coins
Route::post('/player/addRewardCoins', [PlayerController::class, 'AddRewardCoins']);

Route::post('/player/addWinCoins', [PlayerController::class, 'AddWinCoins']);

Route::post('/player/deductCoins', [PlayerController::class, 'DeductCoins']);
